...
@font-face {
  ...
  src: url("https://opensciencedata.esa.int/css/fonts/notesesabold/NotesESAbold.eot");
  src: url("https://opensciencedata.esa.int/css/fonts/notesesabold/NotesESAbold.woff") format("woff"),
    url("https://opensciencedata.esa.int/css/fonts/notesesabold/NotesESAbold.ttf") format("truetype"),
    url("https://opensciencedata.esa.int/css/fonts/notesesabold/NotesESAbold.svg") format("svg");
  font-weight: normal;
  font-style: normal;
}
